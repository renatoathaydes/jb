...
class _JbConfigurationJsonReviver extends ObjectsBase<JbConfiguration> {
  ...
  JbConfiguration convert(Object? value) {
    ...
    return JbConfiguration(
      ...
      sourceDirs: convertPropertyOrDefault(const Arrays<String, Strings>(Strings()), 'source-dirs', value, const ['src']),
      ...
      resourceDirs: convertPropertyOrDefault(const Arrays<String, Strings>(Strings()), 'resource-dirs', value, const ['resources']),
      repositories: convertPropertyOrDefault(const Arrays<String, Strings>(Strings()), 'repositories', value, const []),
      dependencies: convertPropertyOrDefault(const Maps('Map', valueType: _DependencySpecJsonReviver()), 'dependencies', value, const {}),
      processorDependencies: convertPropertyOrDefault(const Maps('Map', valueType: _DependencySpecJsonReviver()), 'processor-dependencies', value, const {}),
  ...
  Converter<Object?, Object?>? getPropertyConverter(String property) {
    switch(property) {
      ...
      case 'dependencies': return const Maps('Map', valueType: _DependencySpecJsonReviver());
      case 'processor-dependencies': return const Maps('Map', valueType: _DependencySpecJsonReviver());
