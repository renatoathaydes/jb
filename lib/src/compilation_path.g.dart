...
final class CompilationPath {
  ...
  @override
  int get hashCode =>
    const ListEquality<Module>().hash(modules) ^ const ListEquality<Jar>().hash(jars);
  CompilationPath copyWith({
    List<Module>? modules,
    List<Jar>? jars,
  }) {
...
final class Module {
  ...
  @override
  int get hashCode =>
    javaVersion.hashCode ^ path.hashCode ^ name.hashCode ^ automatic.hashCode ^ version.hashCode ^ flags.hashCode ^ const ListEquality<Requirement>().hash(requires);
  Module copyWith({
    String? javaVersion,
    String? path,
    String? name,
...
final class Jar {
  ...
  @override
  int get hashCode =>
    javaVersion.hashCode ^ path.hashCode;
  Jar copyWith({
    String? javaVersion,
    String? path,
  }) {
...
class _CompilationPathJsonReviver extends ObjectsBase<CompilationPath> {
  const _CompilationPathJsonReviver(): super("CompilationPath",
  ...
  CompilationPath convert(Object? value) {
    ...
    return CompilationPath(
      modules: convertProperty(const Arrays<Module, _ModuleJsonReviver>(_ModuleJsonReviver()), 'modules', value),
      jars: convertProperty(const Arrays<Jar, _JarJsonReviver>(_JarJsonReviver()), 'jars', value),
    );
  }
  ...
  Converter<Object?, Object?>? getPropertyConverter(String property) {
    switch(property) {
      case 'modules': return const Arrays<Module, _ModuleJsonReviver>(_ModuleJsonReviver());
      case 'jars': return const Arrays<Jar, _JarJsonReviver>(_JarJsonReviver());
      default: return null;
    }
  }
  @override
...
final class Requirement {
  ...
  @override
  int get hashCode =>
    module.hashCode ^ version.hashCode ^ flags.hashCode;
...
class _ModuleJsonReviver extends ObjectsBase<Module> {
  const _ModuleJsonReviver(): super("Module",
    unknownPropertiesStrategy: UnknownPropertiesStrategy.forbid);
  ...
  Module convert(Object? value) {
    ...
    checkRequiredProperties(keys);
    const knownProperties = {'javaVersion', 'path', 'name', 'automatic', 'version', 'flags', 'requires'};
    final unknownKey = keys.where((k) => !knownProperties.contains(k)).firstOrNull;
    if (unknownKey != null) {
    ...
    return Module(
      ...
      requires: convertProperty(const Arrays<Requirement, _RequirementJsonReviver>(_RequirementJsonReviver()), 'requires', value),
    );
  }
  ...
  Converter<Object?, Object?>? getPropertyConverter(String property) {
    switch(property) {
      case 'javaVersion': return const Strings();
      case 'path': return const Strings();
      case 'name': return const Strings();
      case 'automatic': return const Bools();
      case 'version': return const Strings();
      case 'flags': return const Strings();
      case 'requires': return const Arrays<Requirement, _RequirementJsonReviver>(_RequirementJsonReviver());
      default: return null;
    }
  }
  @override
  Iterable<String> getRequiredProperties() {
    return const {'javaVersion', 'path', 'name', 'automatic', 'version', 'flags', 'requires'};
  }
  @override
  String toString() => 'Module';
}
class _JarJsonReviver extends ObjectsBase<Jar> {
  const _JarJsonReviver(): super("Jar",
    unknownPropertiesStrategy: UnknownPropertiesStrategy.forbid);
...
class _RequirementJsonReviver extends ObjectsBase<Requirement> {
  const _RequirementJsonReviver(): super("Requirement",
    unknownPropertiesStrategy: UnknownPropertiesStrategy.forbid);
  ...
  Converter<Object?, Object?>? getPropertyConverter(String property) {
    switch(property) {
      case 'module': return const Strings();
      case 'version': return const Strings();
      case 'flags': return const Strings();
      default: return null;
    }
