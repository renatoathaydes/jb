...
final class _JBuildActor implements Handler<JavaCommand, Object?> {
  ...
  static Future<_JBuildRpc> _startRpc(
    ...
    if (portNumber == null) {
      ...
      throw DartleException(
        message:
            'Could not obtain port from RpcMain JBuild Process. '
...
class _JBuildRpc {
  ...
  Future<void> runJBuild(
    ...
    final Object? result;
    try {
      result = await _runJava('runJBuild', [
        args,
  ...
  Future<Object?> _runJava(
    String methodName,
    List<Object> args,
    _RpcRequestMetadata requestMetadata,
  ) async {
