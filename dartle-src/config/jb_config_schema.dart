...
const _developer = Objects('Developer', {
...
const jbConfig = Objects(
  'JbConfiguration',
  {
    ...
    'manifest': Property(
      Nullable(Strings()),
      description:
          'Manifest file to pass to the jar tool. '
          'Use "-" to generate no manifest',
    ),
    'extension-project': Property(
      Nullable(Strings()),
      description: 'Path to a jb extension',
    ),
    'source-dirs': Property(
      Arrays(Strings()),
      defaultValue: [],
      description: 'Java Source directories',
    ),
    'output-dir': Property(
      Nullable(Strings()),
      description:
    ...
    'resource-dirs': Property(
      Arrays(Strings()),
      defaultValue: [],
      description: 'Java Resource directories',
    ),
