...
void main() {
  group('XML-RPC Request', () {
    ...
    test('method call with single int array arg', () {
      expect(
        utf8.decode(
          createRpcMessage('numbers', const [
            [42, 24],
          ]),
        ),
        equals(
    ...
    test('method call with struct argument', () {
      expect(
        ...
        equals(
          ...
          '</member></struct></value>'
          '<value><struct>'
          '<member><name>path</name><value>bar/zort</value></member>'
          '<member><name>kind</name><value>modified</value></member>'
          '</struct></value>'
          '</data></array></value></member>'
          '<member><name>outputChanges</name>'
          '<value><array><data>'
          '<value><struct>'
          '<member><name>path</name><value>output</value></member>'
          '<member><name>kind</name><value>deleted</value></member>'
          '</struct></value>'
          '</data></array></value>'
          '</member></struct>'
          '</value></param>'
    ...
    test('method call with any Object implementing toJson', () {
      final serializable = SerializesToMap({
        'foo': 'bar',
        'zort': true,
        'n': 42,
      });
